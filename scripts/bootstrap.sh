...
echo "List contentx of /home/zentacular/.zen"
...
scp -r /home/zentacular/.zen/blocks root@${IPV4}:~/.zen > /dev/null
scp -r /home/zentacular/.zen/chainstate root@${IPV4}:~/.zen > /dev/null
